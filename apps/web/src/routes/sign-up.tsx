    ...
    <div className="flex min-h-[calc(100vh-65px)] flex-col items-center justify-center px-6 py-16">
      <div className="flex w-full max-w-md flex-col items-center gap-8">
        <div className="flex flex-col items-center gap-3 text-center">
          <h1 className="text-display-lg tracking-tight text-foreground max-md:text-heading-lg">
            Create your account
          </h1>
          <p className="text-subtitle text-steel">Start analyzing code with confidence.</p>
        </div>
